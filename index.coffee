...
umin2json = (rid,cmd,$) ->
  trial =
    ...
    URL_en: $("tr:first-child:contains('閲覧ページへのリンク')").siblings().children("td:first-child:contains('英語URL')").siblings(":nth-child(2)").text().replace(/[\r\n\t]/g,"")
    rid: rid
    ...
    objective:
      ...
      objective1_en: $("tr:first-child:contains('目的(Objectives)')").siblings().children("td:first-child:contains('目的1\n(Narrative objectives1)')").siblings(":nth-child(3)").text().replace(/[\r\n\t]/g,"")
